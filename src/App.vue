...
import Header from './components/in-map-view/Header.vue';
import Main from './components/in-map-view/Main.vue';
import Footer from './components/in-map-view/Footer.vue';
